...
t_poly = 0 * r_core        # polymer jacket thickness
t_buffer = 3 * r_core      # thickness of buffer region
...
n0 = n_outer                            # base refractive index for V function
